...
@Component({
  ...
  templateUrl: './solicitud-edicion.page.html',
  styleUrls: ['./solicitud-edicion.page.scss'],
})
export class SolicitudEdicionPage implements OnInit {
  ...
  updateSolicitud() {
    ...
    this.solicitudesServiceValidate.updateSolicitud(this.solicitud,this.solicitud.id).then(() => {
      ...
      this.nav.navigateForward('/solicitudes-autorizar');
    });
  }
